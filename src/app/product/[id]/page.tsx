    ...
    <div className="container mx-auto max-w-4xl px-4 py-12">
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-4">
            ...
            <Badge variant={product.availability === 'In Stock' ? 'default' : 'destructive'} className="flex items-center gap-2 bg-accent py-1 text-sm text-accent-foreground">
      ...
      {producer && (
        <Card className="mt-12">
          <CardHeader>
            <CardTitle>From the Producer</CardTitle>
          </CardHeader>
          <CardContent>
